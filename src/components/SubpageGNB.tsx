...
export function SubpageGNB() {
  ...
  return (
    <nav className={`fixed top-0 w-full z-30 transition-all duration-700 ease-in-out bg-white shadow-sm ${
              ...
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.href}
                    href={item.href}
                    className={`text-[16px] font-['Pretendard'] text-black transition-all duration-300 hover:font-bold ${
